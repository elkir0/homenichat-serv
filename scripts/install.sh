...
MANAGER_CONF
        ...
        # Standalone mode: write manager.conf directly with AMI enabled
...
MANAGER_CONF
        ...
        success "AMI configured for Homenichat (manager.conf - standalone mode)"
    fi
...
ENV_FILE
    ...
    # Add AMI configuration if Asterisk was installed (standalone or FreePBX)
